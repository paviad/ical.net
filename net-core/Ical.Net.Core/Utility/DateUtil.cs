...
namespace Ical.Net.Utility
{
    internal static class DateUtil
    {
        ...
        public static DateTimeZone GetZone(string tzId, bool useLocalIfNotFound = true)
        {
            ...
            zone = DateTimeZoneProviders.Tzdb.GetZoneOrNull(tzId);
            if (zone != null)
            {
                return zone;
            }
            ...
            zone = DateTimeZoneProviders.Tzdb.GetZoneOrNull(newTzId);
            if (zone != null)
            {
                return zone;
            }
        ...
        public static bool IsSerializationTimeZone(DateTimeZone zone) => DateTimeZoneProviders.Tzdb.GetZoneOrNull(zone.Id) != null;
